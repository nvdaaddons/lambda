...
* Prise en charge de la nouvelle version de NVDA (prise en charge de Python
  3)
* Résolution d'un problème tout en appuyant sur la commande Dupliquer les
  lignes NVDA+d dans une ligne vide a provoqué le collage du contenu du
  presse-papiers. Maintenant, lorsque vous appuyez sur NVDA+d et que vous
  êtes dans une ligne vide, une nouvelle ligne vide apparaît comme prévu.
